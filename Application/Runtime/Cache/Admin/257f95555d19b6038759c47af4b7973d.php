<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageContent">
    <form action="/index.php/Admin/Inner/addad" class="pageForm" data-toggle="validate"  enctype="multipart/form-data"   data-reload-navtab="true">
        <table class="table table-condensed table-hover">
            ...
            <tr>
                <td>
                    ...
                    <select name="ad_position" id="j_dialog_position" data-toggle="selectpicker">
                        ...
                        <option value="2">首页业务</option>
                        <option value="3">首页客户链接</option>
                    </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="ad_link" id="j_dialog_link" value="" size="20">
                </td>
            </tr>
            </tbody>
        </table>
